...
class MLPlay:
    def __init__(self, player):
        ...
        self.line = 0
        self.lines =   [70, 140, 210, 280, 350, 420, 490, 560, 0]
        self.moveL = None
        self.moveR = None
        pass
    ...
    def update(self, scene_info):
        ...
        for car in scene_info["cars_info"]:
            if car["id"] != self.player_no:
                ...
                # print("\t", X, car["pos"])
                if (X  == self.line or X == self.line + 1) and ((y >= 0 and  y <= 400) or (y <= 0 and y >= -100 )):
        ...
        if not change:
            ...
            nlcar, nlX, nly = nearst(left)
            nrcar, nrX, nry = nearst(right)
            ...
            if self.moveL:
                ...
                if self.car_pos[1] - nlcar["pos"][1] < 120:
                    print("\tBREAK!!\n\n", flush = True)
                ...
                if self.car_pos[1] - nrcar["pos"][1] < 120:
                    print("\tBREAK!!\n\n", flush = True)
